...
/**
 * Tipos de Equipos search form.
 */
class EquipoTiposSearchForm implements FormInterface {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'quipo_tipos_search_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $entity = NULL) {
    ...
    $form['actions']['cancel'] = [
      ...
      '#url' => Url::fromRoute('io_generic_abml.equipo_tipo.list'),
    ];
