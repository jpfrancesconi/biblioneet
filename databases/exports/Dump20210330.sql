...
INSERT INTO `bn_article` VALUES (1,'FICCIONES',NULL,'1234',1,1,1,'2021-02-22 12:00:00',NULL,NULL),(2,'CORONA VIRUS 2020',NULL,'43331',2,1,1,'2021-02-24 12:00:00',NULL,NULL),(3,'MY FIRST ARTICLE',NULL,'123',1,1,1,'2021-03-06 14:26:00',NULL,NULL),(4,'EL DVD DE PANAM',NULL,'',3,2,1,'2021-03-06 15:03:43',NULL,NULL),(6,'MI PLANTA DE NARANJA LIMA',NULL,'348977',1,1,1,'2021-03-17 19:05:33',NULL,NULL),(8,'ENCICLOPEDIA ENCARTA 2021',27,'3452345',3,2,1,'2021-03-17 23:33:15',NULL,NULL),(9,'TEST MULTIMEDIA 1',27,'2432342',3,2,1,'2021-03-17 23:47:05',NULL,NULL),(10,'MULTIMEDIA DE 3 INSTANCIAS',NULL,'34523234',3,2,1,'2021-03-18 22:55:45',NULL,NULL),(12,'CALCULUS, VOLUMEN 1 : INTRODUCCIóN, CON VECTORES Y GEOMETRíA ANALíTICA',30,'123456',1,1,1,'2021-03-25 16:50:47',NULL,NULL);
...
INSERT INTO `bn_article_format` VALUES (1,'FÍSICO',1,1,'2021-03-06 14:56:07',NULL,NULL),(2,'DIGITAL',1,1,'2021-03-06 14:56:07',NULL,NULL);
...
INSERT INTO `bn_article_type` VALUES (1,'LIBRO',1,1,'2021-03-06 14:55:59',NULL,NULL),(2,'REVISTA',1,1,'2021-03-06 14:55:59',NULL,NULL),(3,'MULTIMEDIA',1,1,'2021-03-06 14:55:59',NULL,NULL),(4,'MONOGRAFÍA',1,1,'2021-03-06 14:55:59',NULL,NULL),(5,'DIARIO',1,1,'2021-03-06 14:55:59',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='Represent authors on the sytem';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bn_book` VALUES (1,'978-5-521-05985-0',1,'2017',173,'ESPAÑOL',1,1,'2021-02-18 12:00:00',1,'2021-02-18 12:00:00'),(2,'4529384856',1,'2007',193,'ESPAÑOL',6,1,'2021-03-17 07:03:33',NULL,NULL),(3,'534545534',1,'1954',1544,'ESPAÑOL',3,1,'2021-02-01 12:00:12',NULL,NULL),(4,'978-84-291-5002-5',2,'1972',836,'ESPAÑOL',12,1,'2021-03-25 04:03:47',NULL,NULL);
...
INSERT INTO `bn_editorial` VALUES (1,'DEBOLSILLO',1,1,'2021-02-18 12:00:00',1,'2021-02-18 12:00:00'),(2,'REVERTÉ',1,1,'2021-03-25 00:00:00',NULL,NULL);
...
CREATE TABLE `bn_instance` (
  ...
  `article_id` bigint(20) NOT NULL COMMENT 'Article which this instance belong to',
  `createdby` int(10) unsigned NOT NULL COMMENT 'Record creator user',
  `createdon` datetime NOT NULL DEFAULT current_timestamp() COMMENT 'Record creaion date',
  `updatedby` int(10) unsigned DEFAULT NULL COMMENT 'Record last updated user',
  `updatedon` datetime DEFAULT NULL COMMENT 'Record last updated date',
...
INSERT INTO `bn_instance` VALUES (1,NULL,1,10,1,'2021-03-18 22:55:45',NULL,NULL),(2,NULL,1,10,1,'2021-03-18 22:55:45',NULL,NULL),(3,NULL,1,10,1,'2021-03-18 22:55:45',NULL,NULL),(4,NULL,1,11,1,'2021-03-25 16:46:20',NULL,NULL),(5,NULL,1,11,1,'2021-03-25 16:46:20',NULL,NULL),(6,NULL,1,11,1,'2021-03-25 16:46:20',NULL,NULL),(7,NULL,1,11,1,'2021-03-25 16:46:20',NULL,NULL),(8,NULL,1,11,1,'2021-03-25 16:46:20',NULL,NULL),(9,NULL,1,12,1,'2021-03-25 16:50:47',NULL,NULL),(10,NULL,1,12,1,'2021-03-25 16:50:47',NULL,NULL),(11,NULL,1,12,1,'2021-03-25 16:50:47',NULL,NULL),(12,NULL,1,12,1,'2021-03-25 16:50:47',NULL,NULL),(13,NULL,1,12,1,'2021-03-25 16:50:47',NULL,NULL);
...
--
-- Table structure for table `bn_multimedia`
--

DROP TABLE IF EXISTS `bn_multimedia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bn_multimedia` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `description` text NOT NULL COMMENT 'Multimedia Description',
  `article_id` bigint(20) NOT NULL COMMENT 'Article wich this multimedia record belong to',
  `createdby` int(10) unsigned NOT NULL COMMENT 'Record creator user',
  `createdon` datetime NOT NULL DEFAULT current_timestamp() COMMENT 'Record creaion date',
  `updatedby` int(10) unsigned DEFAULT NULL COMMENT 'Record last updated user',
  `updatedon` datetime DEFAULT NULL COMMENT 'Record last updated date',
...
--
-- Dumping data for table `bn_multimedia`
--

LOCK TABLES `bn_multimedia` WRITE;
/*!40000 ALTER TABLE `bn_multimedia` DISABLE KEYS */;
INSERT INTO `bn_multimedia` VALUES (1,'Multimedia Description',4,1,'2021-03-13 12:00:00',NULL,NULL),(2,'MICROSOFT ENCARTA FUE UNA ENCICLOPEDIA MULTIMEDIA DIGITAL PUBLICADA POR MICROSOFT CORPORATION ENTRE 1993 Y 2009. EN 2008, LA EDICIóN COMPLETA EN INGLéS DE ENCARTA PREMIUM CONTENíA MáS DE 62 000 ARTíCULOS, MIENTRAS QUE SU VERSIóN EN ESPAñOL INCLUíA UNOS 43 000',8,1,'2021-03-17 11:03:15',NULL,NULL),(3,'TEST MULTI',9,1,'2021-03-17 11:03:05',NULL,NULL),(4,'ESTA ES LA DESCRIPCION DEL MULTI',10,1,'2021-03-18 10:03:45',NULL,NULL);
/*!40000 ALTER TABLE `bn_multimedia` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-03-30  7:53:42
